...
class MaoYanDetailBean:
    ...
    def set_data(self,
        ...
        self.movie_avatar_url = movie_avatar_url
        self.movie_name = movie_name
        self.movie_en_name = movie_en_name
        self.movie_category = movie_category
        self.movie_country = movie_country
        self.movie_duration = movie_duration
        self.movie_release_info = movie_release_info
        self.movie_release_time = movie_release_time
        self.movie_release_area = movie_release_area
        self.movie_score_content = movie_score_content
        self.movie_want_to_see_count = movie_want_to_see_count
        self.movie_stats_people_count_content = movie_stats_people_count_content
        self.movie_stats_people_count_unit_content = movie_stats_people_count_unit_content
        self.movie_box_value_content = movie_box_value_content
        self.movie_box_unit_content = movie_box_unit_content
        self.introduce_content = introduce_content
